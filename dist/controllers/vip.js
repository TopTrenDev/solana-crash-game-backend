...
var vip_exports = {};
__export(vip_exports, {
  checkAndApplyRakeback: () => checkAndApplyRakeback,
  getNextVipLevelFromWager: () => getNextVipLevelFromWager,
  getVipLevelFromWager: () => getVipLevelFromWager,
  vipLevelCOLORS: () => vipLevelCOLORS,
  vipLevelNAME: () => vipLevelNAME,
  vipLevels: () => vipLevels
});
module.exports = __toCommonJS(vip_exports);
...
var getNextVipLevelFromWager = (wager) => {

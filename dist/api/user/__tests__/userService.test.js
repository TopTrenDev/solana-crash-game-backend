...
describe("userService", () => {
  ...
  describe("findAll", () => {
    it("return all users", async () => {
      ...
      expect(result.statusCode).toEqual(import_http_status_codes7.StatusCodes.OK);
    ...
    it("returns a not found error for no users found", async () => {
      ...
      const result = await userService.findAll();
      expect(result.statusCode).toEqual(import_http_status_codes7.StatusCodes.NOT_FOUND);
    ...
    it("handles errors for findAllAsync", async () => {
      ...
      const result = await userService.findAll();
      expect(result.statusCode).toEqual(import_http_status_codes7.StatusCodes.INTERNAL_SERVER_ERROR);
      expect(result.success).toBeFalsy();

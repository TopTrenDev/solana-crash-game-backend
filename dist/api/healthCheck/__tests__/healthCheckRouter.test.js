...
// src/api/healthCheck/__tests__/healthCheckRouter.test.ts
...
describe("Health Check API endpoints", () => {
  it("GET / - success", async () => {
    const response = await (0, import_supertest.default)(app).get("/health-check");
...
mime-types/index.js:
   ...
   *)
*/
//# sourceMappingURL=healthCheckRouter.test.js.map